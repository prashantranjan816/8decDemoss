...
public class Xls_Reader {
	...
	// "C:\\Users\\h00148\\eclipse-workspace\\TestAutomation_Latest\\src\\20170815_HMD_Master.xlsx";
	public String path;
	...
	public boolean setCellData(String sheetName, String colName, int rowNum, long data) {
		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);
	...
	public Object[] getallsheetName() {

		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);
			int TotalSheet = workbook.getNumberOfSheets();
			Object[] sheetName = new Object[TotalSheet]; 
